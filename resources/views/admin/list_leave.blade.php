...
@section('content')
    ...
    <div class="container-fluid">
        <div class="my-3">
            ...
            <span class="text-muted">List of Leaves</span>
        </div>
        <div class="my-3 row">
            <div class="col">
                                ...
                                @foreach($leaves as $leave)
                                    <tr class="text-center">
                                        ...
                                        <td class="d-flex justify-content-center">
                                            <a href="{{route('admin.update.leaves.page', $leave->leave_id)}}" class="h4 mx-1 mb-0 text-decoration-none text-warning">
                                                <i class="bi bi-pencil-square"></i>
                                            </a>
                                            <form action="{{route('admin.delete.leaves.post', $leave->leave_id)}}" method="POST">
                                                @csrf()
                                                @method('DELETE')
